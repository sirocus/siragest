    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading"><? if(!empty($subservicio)){ ?>¿ Estas seguro que deseas eliminar el subservicio <strong><?=ucfirst($subservicio)?></strong> ?<? }else{ ?>Subservicio borrado correctamente.<? } ?></div>
